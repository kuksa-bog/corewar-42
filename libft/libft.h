...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2018/10/26 16:11:05 by bkuksa            #+#    #+#             */
/*   Updated: 2018/11/12 13:04:16 by bkuksa           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void				*ft_lstfold(t_list *list, void *(*f)(const void *,
					const void*, size_t));
t_list				*ft_lstsplit(char const *s, char c);
int					ft_recursive_power(int nb, int power);
int					ft_kalk(int i, int j, char c);
int					ft_sqrt(int nb);
